  ...
  if (!isRealSanctuary || isPreviewing) {
    return (
      <main className="min-h-screen bg-[#FDFCFB] text-slate-900 overflow-x-hidden selection:bg-sanctuary-secondary selection:text-sanctuary-primary flex flex-col">
        ...
        <header className="min-h-screen flex flex-col items-center justify-center px-6 pt-32 pb-20 relative text-center">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl space-y-8 text-gray-800 relative z-10">
