    ...
    <main className="min-h-screen bg-sanctuary-bg p-8 md:p-24 text-gray-800">
      <div className="max-w-3xl mx-auto space-y-8 bg-white p-8 md:p-12 rounded-3xl shadow-sm">
        ...
        <div className="flex items-center gap-4 text-sanctuary-primary">
          <Shield size={40} />
          <h1 className="text-4xl font-bold font-sacramento text-gray-800">Privacy Policy</h1>
        </div>
        ...
        <section className="space-y-4 text-sm leading-relaxed text-sanctuary-soft text-gray-800">
          ...
          <h2 className="text-xl font-bold text-sanctuary-primary mt-6">1. Overview</h2>
          <p>
            Sanctuary Wizard ("we", "our", or "us") is committed to protecting your privacy. Unlike traditional services, we do not use a central database to store your sanctuary configurations. Your personal data stays in your unique URL.
          </p>

          <h2 className="text-xl font-bold text-sanctuary-primary mt-6">2. Data We Process</h2>
          ...
          <h2 className="text-xl font-bold text-sanctuary-primary mt-6 text-gray-800">3. GDPR Compliance (EU Users)</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-sanctuary-primary mt-6">4. Cookies</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-sanctuary-primary mt-6">5. Contact</h2>
          <p>
            If you have questions about your privacy, you can reach out to us at <span className="font-bold">malthe@mbn-code.dk</span>.
          </p>
        </section>
      </div>
    </main>
